...
public class Duplicate_Lead {
	public static void main(String[] args) throws InterruptedException {
		...
		edge.findElement(By.linkText("Duplicate Lead")).click();
		edge.findElement(By.id("createLeadForm_companyName")).clear();
		edge.findElement(By.id("createLeadForm_companyName")).sendKeys("Sangatha kalaingadaa !");
		edge.findElement(By.id("createLeadForm_firstName")).clear();
		edge.findElement(By.id("createLeadForm_firstName")).sendKeys("jaiThalai");
		edge.findElement(By.className("smallSubmit")).click();
		Thread.sleep(3000);
		String title2 = edge.getTitle();
